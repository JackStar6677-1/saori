...
async function main() {
    ...
    const pin = async (channel, embed) => { const message = await post(`/channels/${channel.id}/messages`, { embeds: [embed] }); await put(`/channels/${channel.id}/pins/${message.id}`); };
